...
```{r, echo=FALSE, out.width = "75px"}
knitr::include_graphics("https://banner2.kisspng.com/20180218/khe/kisspng-rstudio-macos-clip-art-r-5a89b3da0b6081.4779308415189739140466.jpg")
```
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; `r icon::fa("angle-double-right", size = 2)` &emsp;
```{r, echo=FALSE, out.width = "75px"}
knitr::include_graphics("https://www.gislounge.com/wp-content/uploads/2018/06/google-earth-engine.jpg")
```
